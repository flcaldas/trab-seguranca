...
class Pinger(object):
    ...
    def __init__(self, msg, target_host, count=DEFAULT_COUNT, timeout=DEFAULT_TIMEOUT):
    ...
    def send_ping(self, sock,  ID):
        ...
        bytes_In_double = struct.calcsize("d")
        data = (192 - bytes_In_double) * self.msg
...
if __name__ == '__main__':
    ...
    parser.add_argument('msg', action="store", help=u'type message')
